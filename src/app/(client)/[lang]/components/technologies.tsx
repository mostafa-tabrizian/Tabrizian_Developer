...
const Technologies = ({ lang }: { lang: string }) => {
   return (
      <div
         id='technologies'
         className='mx-auto mt-60 grid min-h-screen max-w-screen-lg items-center justify-center'
      >
         {langDecider(
            lang,
            <div>
               ...
               <div>
                  <div className='rtl grid md:grid-cols-2 md:gap-x-20 lg:gap-x-40'>
                     <div className='mt-16'>
                        ...
                        <div className='mt-3 flex space-x-5 space-x-reverse md:space-x-10 md:space-x-reverse'>
                           <div className='h-20 w-20 text-center md:h-24 md:w-24'>
                              <Image
                                 className='mb-1 p-2'
                                 style={{
