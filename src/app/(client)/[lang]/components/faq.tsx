         ...
         <div className='mx-5 space-y-4'>
            ...
            >
               ...
               >
                  {langDecider(
                     lang,
                     <p className='verdana whitespace-wrap mx-5 flex w-full text-left text-sm md:text-base text-slate-100'>
                        &quot;What <span className='mx-2 contents text-indigo-300'>services</span>{' '}
                        do you offer as a freelance web developer?&quot;
                     </p>,
                     <span className='yekanBold mx-5 flex w-full text-right text-sm md:text-base text-slate-100'>
               ...
               <Collapse unmountOnExit in={q1}>
                  {langDecider(
                     lang,
                     <p className='mx-5 mt-4 text-left text-sm md:text-base text-slate-400'>
                     ...
                     <p className='yekan mx-5 mt-4 text-right text-sm md:text-base text-slate-400'>
               ...
               <Collapse unmountOnExit in={q2}>
                  {langDecider(
                     ...
                     <p className='mx-5 mt-4 text-left text-sm md:text-base text-slate-400'>
                        ...
                        <Link
                           href='/#technologies'
                           className=' text-sm md:text-base text-indigo-300 underline decoration-wavy decoration-1 underline-offset-4'
                        >
                     ...
                     <p className='yekan mx-5 mt-4 text-right text-sm md:text-base text-slate-400'>
                        ...
                        <Link
                           href='/#technologies'
                           className=' yekanBold text-sm md:text-base text-indigo-300 underline decoration-wavy decoration-1 underline-offset-4'
                        >
                           تکنولوژی هایی
                        </Link>{' '}
            ...
            {langDecider(
               lang,
               <p className='mx-5 mt-4 text-left text-sm md:text-base text-slate-400'></p>,
               <p className='yekan mx-5 mt-4 text-right text-sm md:text-base text-slate-400'></p>,
            )}
