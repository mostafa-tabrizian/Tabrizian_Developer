         ...
         {categoriesData.map((category, idx) => {
            return (
               <Link
                  ...
                  href={`/category/${hyphen(category.slug)}?type=category&name=${category.name}`}
                  ...
                  {category.cover ? (
                     <div>
                        <Image
                           ...
                           src={`https://tabrizian.storage.iran.liara.space/tabrizian_codes/projects/${category.cover}`}
                           fill
                           alt={category.name}
