         ...
         },
         {
            ...
            cell: (info) => {
               ...
               return (
                  <Link
                     target='_blank'
                     href={`https://tabrizian.storage.iran.liara.space/tabrizian_codes/blogs/thumbnail/${value}`}
                  >
                     {value ? (
                        <Image
                           className='rounded-md object-cover'
                           src={`https://tabrizian.storage.iran.liara.space/tabrizian_codes/blogs/thumbnail/${value}`}
                           alt={String(value)}
                           height={50}
                           width={50}
                        />
