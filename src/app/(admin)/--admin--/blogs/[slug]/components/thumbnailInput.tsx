      ...
      return (
         <div className=''>
            {thumbnail && typeof thumbnail == 'string' ? (
               <div>
                  <span className='yekan text-base text-slate-400'>Thumbnail</span>

                  <div className='relative'>
                     <Link
                        target='_blank'
                        href={`https://tabrizian.storage.iran.liara.space/tabrizian_codes/blogs/thumbnail/${thumbnail}`}
                     >
                        <div className='mx-auto flex justify-center'>
                           <Image
                              className='rounded-lg p-1'
                              src={`https://tabrizian.storage.iran.liara.space/tabrizian_codes/blogs/thumbnail/${thumbnail}`}
                              alt='blog thumbnail'
                              width={600}
                              height={900}
                              loading='lazy'
               ...
               <>
                  {thumbnailPrevMemo?.length ? (
                     <div className='mb-3'>
                        <span className='verdana mb-3 text-slate-400'>Thumbnail (Preview)</span>
                  ...
                  <div
                     ...
                     className='w-full rounded-lg border-2 border-sky-700 text-base hover:border-sky-600'
                  >
                     <Button
                        type='button'
                        // @ts-ignore
