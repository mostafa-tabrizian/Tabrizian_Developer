         ...
         <div className='grid h-screen items-center'>
            <div className='relative'>
               <h2 className='text-center text-[6rem] font-bold'>
                  خطای <span className='text-[7rem] font-bold text-sky-400'>۴۰۴</span>
               </h2>
               <span className='absolute -top-[14rem] right-0 -z-10 h-[40rem] w-[40rem] bg-gradient-radial from-sky-200 via-transparent to-transparent'></span>
               ...
               <div className='mt-10'>
                  <Link
                     href='/'
                     className='rounded-2xl bg-sky-400 px-4 py-2 text-lg text-white shadow-xl shadow-sky-200'
                  >
